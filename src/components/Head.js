  ...
  <div className="bg-white shadow-md sticky top-0 z-50 px-4 py-2">
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-3">
        ...
        <a href="/" className="hidden sm:block">
          <img
            ...
            alt="logo"
            src="https://www.pngitem.com/pimgs/m/525-5253012_youtube-logo-hd-png-download.png"
          />
        </a>
      </div>
      ...
      <img
        ...
        alt="video "
        src="https://tse2.mm.bing.net/th/id/OIP.JLa6PUrs3cpXmoCViUwDaAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
      />

      <img 
        className="h-6 w-6 cursor-pointer hover:scale-110 transition-transform"
        alt ="notification"
        src="https://th.bing.com/th/id/R.14d4eefea72e75235dcaefe32b423df6?rik=bcXTESVBZvCUxA&riu=http%3a%2f%2fwww.pngmart.com%2ffiles%2f9%2fYouTube-Bell-Icon-PNG-File.png&ehk=P5c5pvoeSHq7J0AUbDaxyhFGZn8u9AK3UXqou4z7EJ0%3d&risl=&pid=ImgRaw&r=0"
      />

      {/* Right: User Icon */}
      <img
        className="h-7 w-7 rounded-full hover:scale-110 transition-transform duration-200"
        alt="user"
